            ...
            <div className="text-white space-y-6">
              <div className="space-y-2">
                <div className="flex items-center space-x-3">
                  <span className="text-blue-400 font-medium text-sm tracking-wide uppercase">
                    {apod.media_type === 'video' ? 'Astronomy Video' : 'Astronomy Picture'} of the Day
                  </span>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button
                  ...
                  className="bg-white bg-opacity-20 hover:bg-opacity-30 backdrop-blur-sm px-6 py-3 rounded-lg font-medium transition-colors inline-flex items-center space-x-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-white bg-opacity-10 backdrop-blur-md rounded-xl p-6">
                ...
                <form onSubmit={handleDateSubmit} className="space-y-4">
                  <input
                    ...
                    min={getMinDate()}
                    max={getTodayDate()}
                    className="w-full px-4 py-3 rounded-lg bg-white bg-opacity-20 backdrop-blur-sm text-white placeholder-gray-300 border border-white border-opacity-30 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent"
                  />
                  <button
                    type="submit"
